...
MicroPilot's autopilot is a commercial autopilot with a codebase of 500k lines of C code. 
The primary control mechanism is a hierarchy of PID loops, as explained both in chapter~\ref{sec:motivation} and \ref{sec:approach}. 
