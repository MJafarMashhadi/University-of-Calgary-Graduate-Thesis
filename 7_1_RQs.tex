...
\begin{itemize}
    ...
    \item Number of convolutional filters in each layer: 4 values between 16 to 72
...
In total, there were 480 configurations that were used to train models on training dataset and evaluated on test (tuning) dataset. 
