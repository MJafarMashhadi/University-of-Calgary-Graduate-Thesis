...
\subsection{RQ1 (CPD) Performance Metrics} \label{sec:CPD_metrics}
...
\subsection{RQ2 (State detection) metrics}
...
\subsection{RQ1 (CPD) baselines} \label{sec:CPD_baseline}
...
\subsection{RQ2 (Multi-class classification) baselines}
...
\section{Dataset and the Data Collection Process}\label{sec:mp_data_collection_process}
